...
export namespace Prisma {
  ...
  */
	...
	type GetDinosaurGroupByPayload<T extends DinosaurGroupByArgs> =
		Prisma.PrismaPromise<
			Array<
				& PickArray<DinosaurGroupByOutputType, T['by']>
				& {
					[P in ((keyof T) & (keyof DinosaurGroupByOutputType))]:
	...
	> = S extends { select: any; include: any }
		...
		: S extends { select: any } & (DinosaurArgs | DinosaurFindManyArgs) ? {
				[P in TruthyKeys<S['select']>]: P extends keyof Dinosaur
					? Dinosaur[P]
					: never;
			}
		: Dinosaur;
	...
	export interface DinosaurDelegate<
	...
	> {
		 ...
		 */
		findUnique<
			T extends DinosaurFindUniqueArgs,
		...
		>(
			...
			'findUnique',
			'Dinosaur'
		> extends True ? Prisma__DinosaurClient<DinosaurGetPayload<T>>
			: Prisma__DinosaurClient<DinosaurGetPayload<T> | null, null>;
		 ...
		 */
		findFirst<
			T extends DinosaurFindFirstArgs,
			LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
				? T['rejectOnNotFound']
				: undefined,
		>(
		 ...
		 * })
		 */
		aggregate<T extends DinosaurAggregateArgs>(
			args: Subset<T, DinosaurAggregateArgs>,
		): Prisma.PrismaPromise<GetDinosaurAggregateType<T>>;
		...
		>(
			args:
				& SubsetIntersection<T, DinosaurGroupByArgs, OrderByArg>
				& InputErrors,
		): {} extends InputErrors ? GetDinosaurGroupByPayload<T>
	 ...
	 */
	export class Prisma__DinosaurClient<T, Null = never>
	...
	export type DinosaurUpdateManyArgs = {
		 ...
		 */
		data: XOR<
			DinosaurUpdateManyMutationInput,
			DinosaurUncheckedUpdateManyInput
		>;
		/**
	...
	export type DinosaurScalarFieldEnum =
		(typeof DinosaurScalarFieldEnum)[keyof typeof DinosaurScalarFieldEnum];
